...
public interface YGDMMapper extends SqlMapper {
    ...
    @Select("SELECT (SELECT GX.MRZ FROM GY_XTCS GX where GX.CSMC='YLJGDM_NEW') AS ORGAN_CODE,GY.YGDM,GY.YGBH,GY.YGXM,GY.PYDM,GY.SFZ,GY.YGXB,decode(GY.YGXB,1,'男','女') AS SEX_NAME, \n" +
